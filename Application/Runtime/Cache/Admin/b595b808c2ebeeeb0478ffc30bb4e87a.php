...
<head>
    ...
    <title>么么秀后台管理系统</title>
</head>
<body>
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">么么秀后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    ...
                    <li>
                        <a data-title="公众号配置" data-href="<?php echo U('More/setup');?>" href="<?php echo U('More/wechat');?>" target="iframe" >公众号配置</a>
                    </li>
        ...
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    ...
                    <!-- <li>
                        <a data-title="评论管理" data-href="<?php echo U('Product/comment');?>" href="<?php echo U('Product/comment');?>" target="iframe">评论管理</a>
                    </li> -->
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-product">
            <dt><i class="Hui-iconfont">&#xe620;</i> 自定义菜单管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li>
                        <a data-title="自定义菜单" data-href="<?php echo U('Menu/menu_list');?>" href="<?php echo U('Menu/menu_list');?>" target="iframe">自定义菜单</a>
                    </li>
                    <!-- <li>
                        <a data-title="品牌管理" data-href="<?php echo U('Brand/index');?>" href="<?php echo U('Brand/index');?>" target="iframe">全部品牌</a>
                    </li> -->
        ...
        <dl id="menu-member">
            ...
            <dd>
                ...
                <!--<ul>-->
                    <!--<li><a data-href="<?php echo U('User/index');?>" data-title="代理管理" href="<?php echo U('User/daili');?>" target="iframe">代理管理</a></li>-->
                <!--</ul>-->
                <ul>
                    <li><a data-href="<?php echo U('User/index');?>" data-title="等级管理" href="<?php echo U('User/level_list');?>" target="iframe">等级管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
        ...
        <dl id="menu-tongji2">
            ...
            <dd>
                <ul>
                    <li>
                        <a data-title="提现列表" data-href="<?php echo U('Order/withdraw_list');?>" href="<?php echo U('Order/withdraw_list');?>" target="iframe">提现列表</a>
                    </li>
                </ul>
            </dd>
        </dl>
