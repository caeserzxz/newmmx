...
<div class="page-container">
    <table class="table table-border table-bordered table-bg">
        ...
        <tr class="text-c">
            ...
            <th width="150">直推联创分佣比例</th>
            <th width="130">推荐合伙人分佣比例</th>
            <th width="130">区间佣金比例</th>
            <th width="130">团队佣金比例</th>
            <th width="100">联创复购所得佣金比例</th>
            <th width="100">合伙人复购佣金比例</th>
            <th width="100">复购( )盒起</th>
            <th width="100">操作</th>
        </tr>
        </thead>
        ...
        <!-- 遍历 -->
        <?php if(is_array($level_list)): $i = 0; $__LIST__ = $level_list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($v["id"]); ?>" data-name="<?php echo ($v["name"]); ?>" class="text-c">
                <td><?php echo ($v["level_name"]); ?></td>
                <td><?php echo ($v["direct_lc"]); ?></td>
                <td><?php echo ($v["direct_hh"]); ?></td>
                <td><?php echo ($v["two_commission"]); ?></td>
                <td><?php echo ($v["team_commission"]); ?></td>
                <td><?php echo ($v["repeat_purchase_lc"]); ?></td>
                <td><?php echo ($v["repeat_purchase_hh"]); ?></td>
                <td><?php echo ($v["min_num"]); ?></td>
                <td class="obj_1">
                    <a href="<?php echo U('User/level_edit');?>?id=<?php echo ($v["id"]); ?>">编辑</a>
                </td>
